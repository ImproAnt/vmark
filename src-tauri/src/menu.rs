...
pub fn create_menu(app: &tauri::AppHandle) -> tauri::Result<Menu<tauri::Wry>> {
    ...
    let paragraph_menu = Submenu::with_items(
        ...
        &[
            ...
            &MenuItem::with_id(app, "code-fences", "Code Block", true, Some("Ctrl+CmdOrCtrl+C"))?,
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(
                app,
                "ordered-list",
    ...
    let format_menu = Submenu::with_items(
        ...
        &[
            ...
            &MenuItem::with_id(app, "highlight", "Highlight", true, Some("Alt+CmdOrCtrl+H"))?,
            &PredefinedMenuItem::separator(app)?,
...
fn create_menu_with_shortcuts(
    ...
    let export_submenu = Submenu::with_items(
        ...
        &[
            ...
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "copy-html", "Copy as HTML", true, get_accel("copy-html", "Alt+CmdOrCtrl+C"))?,
        ],
    )?;
    ...
    let find_submenu = Submenu::with_items(
        ...
        &[
            ...
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "use-selection-find", "Use Selection for Find", true, get_accel("use-selection-find", "Alt+F"))?,
        ],
    )?;
    ...
    let paragraph_menu = Submenu::with_items(
        ...
        &[
            ...
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "paragraph", "Paragraph", true, get_accel("paragraph", "CmdOrCtrl+0"))?,
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "increase-heading", "Increase Heading Level", true, get_accel("increase-heading", "CmdOrCtrl+="))?,
            &MenuItem::with_id(app, "decrease-heading", "Decrease Heading Level", true, get_accel("decrease-heading", "CmdOrCtrl+-"))?,
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "quote", "Quote", true, get_accel("quote", "Alt+CmdOrCtrl+Q"))?,
            &MenuItem::with_id(app, "code-fences", "Code Block", true, get_accel("code-fences", "Ctrl+CmdOrCtrl+C"))?,
            &PredefinedMenuItem::separator(app)?,
    ...
    let format_menu = Submenu::with_items(
        ...
        &[
            ...
            &MenuItem::with_id(app, "code", "Inline Code", true, get_accel("code", "CmdOrCtrl+`"))?,
            &PredefinedMenuItem::separator(app)?,
            ...
            &MenuItem::with_id(app, "highlight", "Highlight", true, get_accel("highlight", "Alt+CmdOrCtrl+H"))?,
            &PredefinedMenuItem::separator(app)?,
    ...
    let table_submenu = Submenu::with_items(
        ...
        &[
            ...
            &MenuItem::with_id(app, "add-col-after", "Add Column After", true, None::<&str>)?,
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "delete-selected-cells", "Delete Selected Cells", true, None::<&str>)?,
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "align-left", "Align Left", true, None::<&str>)?,
            &MenuItem::with_id(app, "align-center", "Align Center", true, None::<&str>)?,
            &MenuItem::with_id(app, "align-right", "Align Right", true, None::<&str>)?,
    ...
    let view_menu = Submenu::with_items(
        ...
        true,
        &[
            &MenuItem::with_id(app, "source-mode", "Source Code Mode", true, get_accel("source-mode", "F7"))?,
            &PredefinedMenuItem::separator(app)?,
            ...
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "word-wrap", "Toggle Word Wrap", true, get_accel("word-wrap", "F10"))?,
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "sidebar", "Toggle Sidebar", true, get_accel("sidebar", "CmdOrCtrl+Shift+B"))?,
            &MenuItem::with_id(app, "outline", "Toggle Outline", true, get_accel("outline", "Ctrl+CmdOrCtrl+1"))?,
        ],
    )?;
